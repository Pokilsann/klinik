            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" >List Pasien</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <center><h2> LIST DATA Pasien <h2>
			        <h2> Rumah Sehat Syibli <h2></center>
                    <hr>
	                <pre> <a href="formdatapasien.php"><input type="button" name="" value="Add New"/></a> <a href="index.php"><input type="button" name="" value="Home"/></a> </pre>

                    <form method="GET">
                    <?php
                    include "config.php";
                    $tampil = " SELECT 	Kode_Pasien,Nama_Pasien,Tanggal_Lahir,Tempat_Lahir,Jenis_Kelamin,Alamat,
                    Telepon,Email FROM t_pasien";
                    ...
                    while ($row=@mysqli_fetch_array($hasil))
                    {
                        echo "<tr>
                            ...
                            <td>
                            <button> <a href='editpasien.php?Kode_Pasien=$row[Kode_Pasien]'> Edit </a> </button>
                            |
                            <button> <a href='deletepasien.php?Kode_Pasien=$row[Kode_Pasien]'> Delete </a> </button>
                            </tr>";
