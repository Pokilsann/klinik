        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">                   
                    <form action="proses_inputpasien.php" method="post">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kode_pasien" placeholder="masukkan Kode pasien">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jenis_kelamin" placeholder="Masukkan Jenis Kelamin Anda">
                                    </div>


                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" name class="form-label">Alamat</label>
                                        <textarea class="form-control" name="alamat" rows="3"></textarea>
                                    </div>

                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">No Telepon</label>
                                        <input type="number" class="form-control" name="telepon" placeholder="Masukkan No Telepon Anda">
                                    </div>
                                    <div class="mb-3">
