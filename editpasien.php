            ...
            <div id="content">
                ...
                <div class="container-fluid">                   
                        ...
                        <div class="container">
                            ...
                            $data = mysqli_query($koneksi,"select * from t_pasien where Kode_Pasien='$Kode_Pasien'");
                                ...
                                <form method="post" action="updatepasien.php">
                                    <table>
                                        ...
                                        <tr>			
                                            <td>Nama Pasien</td>
                                            <td>
                                                <input type="hidden" name="Nama_Pasien" value="<?php echo $d['Nama_Pasien']; ?>">
                                        ...
                                        <tr>			
                                            <td>Tempat Lahir</td>
                                            <td>
                                                <input type="hidden" name="Tempat_Lahir" value="<?php echo $d['Tempat_Lahir']; ?>">
                                        ...
                                        <tr>			
                                            <td>Jenis Kelamin</td>
                                            <td>
                                                <input type="hidden" name="Jenis_Kelamin" value="<?php echo $d['Jenis_Kelamin']; ?>">
