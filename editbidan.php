            ...
            <div id="content">
                ...
                <div class="container-fluid">                   
                        ...
                        <div class="container">
                            ...
                            $data = mysqli_query($koneksi,"select * from t_bidan where Kode_Bidan='$Kode_Bidan'");
                            while($d = mysqli_fetch_array($data)){
                                ?>
                                <form method="post" action="updatebidan.php">
                                    <table>
                                        <tr>			
                                            <td></td>
                                            <td>
                                        ...
                                        <tr>			
                                            <td>Nama Dokter</td>
                                            <td>
                                                <input type="hidden" name="Nama_Bidan" value="<?php echo $d['Nama_Bidan']; ?>">
                                                <input type="text" name="Nama_Bidan" value="<?php echo $d['Nama_Bidan']; ?>">
                                            </td>
                                        </tr>
                                        <tr>			
                                            <td>Kode Poli</td>
                                            <td>
                                                <input type="hidden" name="Kode_Poli" value="<?php echo $d['Kode_Poli']; ?>">
                                                <input type="text" name="Kode_Poli" value="<?php echo $d['Kode_Poli']; ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td></td>
