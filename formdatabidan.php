            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" >Data Dokter</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">                   
                    <form action="proses_inputbidan.php" method="post">
                        <div class="container">
                            <div class="row justify-content-md-center">
                                ...
                                <div class="col-md-7">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kode_bidan" placeholder="masukkan kode Dokter">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Nama Dokter</label>
                                        <input type="text" class="form-control" name="nama_bidan" placeholder="masukkan nama Dokter">
                                    </div>
                                    <div>
                                        <label>Kode Poli</label>
                                            <select name="kode_poli">
                                            <?php
                                                $query= " SELECT 	Kode_Poli
                                                        FROM		t_poli";
                                                $hasil= @mysqli_query($conn, $query);
                                                while ($tabel =@mysqli_fetch_assoc($hasil))
                                                {
                                                    echo "<option>$tabel[Kode_Poli]</option>";
                                                }
                                            ?>
                                            </select>
                                        </div>    
